...
#define usage_if(a) do { do_usage_if( a , __LINE__); }
while(0);
...
static inline __s32 i2c_smbus_write_quick(int file, __u8
value)
{ return
...
static inline __s32 i2c_smbus_write_byte(int file, __u8
value)
{
return
...
static inline __s32 i2c_smbus_process_call(int file, __u8
command, __u16 value)
{
union i2c_smbus_data data;
data.word = value;
...
#if 0
int eeprom_24c32_write_byte(struct lsm303 *e, __u16
mem_addr, __u8 data)
{
